...
Aplikasi ini memproses:
- Jadwal permanen dari KRS (kelas A/B/C)
- Komitmen dinamis (event insidental)
- Menampilkan hasil dalam bentuk **heatmap ketersediaan kolektif**
